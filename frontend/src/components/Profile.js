...
const Profile = () => {
    ...
    let currentUser=localStorage.getItem("emp_id");
    ...
    useEffect(() => {
        fetchData();
        // if(isAdministrator){
        //     setCurrentUser(localStorage.getItem("admin_id"));
        // }
        // else{
        //     setCurrentUser(localStorage.getItem("emp_id"));
        // }
      }, []);
                ...
                <div className='d-flex flex-column' style={{ width:"1200px", height:"auto", position:"relative", left:"170px"}}>
                    ...
                    <div className='d-flex flex-row' style={{width:"1200px", height:'500px'}}>
                        ...
                        <div style={{ border: "1px solid", width: "450px", marginRight: "5px", borderRadius: "10px", backgroundColor:'white' }}>
                            ...
                            {/* Edit button for user information */}
                            <button className='btn btn-dark' style={{ position: 'absolute', top: '15px', right: '770px', display:`${isAdministrator? 'none' : 'block'}` }} onClick={handleEditUser}>
                        ...
                        <div style={{border:"1px solid", width:"700px", marginLeft:"5px", borderRadius:"10px", paddingLeft:'20px', backgroundColor:"white"}}>
                            ...
                            <button className='btn btn-dark' style={{ position: 'absolute', top: '10px', right: '60px', display:`${isAdministrator? 'none' : 'block'}` }} onClick={handleEdit}>
                                {isEditing ? 'Save' : 'Edit'}
                            </button>
                        </div>
                    </div>
